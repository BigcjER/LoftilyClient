...
public class VanillaFly extends Mode {
    ...
    private final NumberValue keepY = new NumberValue("Vanilla-KeepYSpeed",0.0,0.0,0.2,0.001);
    private final BooleanValue resetMotion = new BooleanValue("Vanilla-ResetMotion",false);
