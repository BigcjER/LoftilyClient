...
@ModuleInfo(name = "ZoomModifier", category = ModuleCategory.Render)
public class ZoomModifier extends Module {
    ...
    public NumberValue zoomInEasingDuring = new NumberValue("ZoomInEasingDuring", 500, 100, 100);
    public NumberValue zoomOutEasingDuring = new NumberValue("ZoomOutEasingDuring", 500, 100, 100);
